...
cities = ["Eldoret","Nyeri","Nanyuki", "Meru","Nakuru","Nyahururu","Nairobi"]
...
def handleUpdates(updates):
    for update in getResult(updates):
        ...
        if text == "check weather":
            ...
            sendMessage("Select Your Town", chatId, keyboard)
        elif text == "/start":
            sendMessage("Welcome to @howsiweathertoday\U0001F326 type 'check weather' to continue", chatId)
            ...
            keyboard = buildKeyboard(["check weather"])
